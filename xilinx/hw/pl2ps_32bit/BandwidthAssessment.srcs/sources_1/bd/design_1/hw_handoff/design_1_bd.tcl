...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXI4StreamConstant32_0, and set properties
  set AXI4StreamConstant32_0 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant32:1.0 AXI4StreamConstant32_0 ]

  # Create instance: AXI4StreamConstant32_1, and set properties
  set AXI4StreamConstant32_1 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant32:1.0 AXI4StreamConstant32_1 ]

  # Create instance: AXI4StreamConstant32_2, and set properties
  set AXI4StreamConstant32_2 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant32:1.0 AXI4StreamConstant32_2 ]

  # Create instance: AXI4StreamConstant32_3, and set properties
  set AXI4StreamConstant32_3 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant32:1.0 AXI4StreamConstant32_3 ]
  ...
  connect_bd_intf_net -intf_net AXI4StreamConstant32_0_M00_AXIS [get_bd_intf_pins AXI4StreamConstant32_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI4StreamConstant32_1_M00_AXIS [get_bd_intf_pins AXI4StreamConstant32_1/M00_AXIS] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI4StreamConstant32_2_M00_AXIS [get_bd_intf_pins AXI4StreamConstant32_2/M00_AXIS] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI4StreamConstant32_3_M00_AXIS [get_bd_intf_pins AXI4StreamConstant32_3/M00_AXIS] [get_bd_intf_pins axi_dma_3/S_AXIS_S2MM]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI4StreamConstant32_0/m00_axis_aclk] [get_bd_pins AXI4StreamConstant32_1/m00_axis_aclk] [get_bd_pins AXI4StreamConstant32_2/m00_axis_aclk] [get_bd_pins AXI4StreamConstant32_3/m00_axis_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk] [get_bd_pins axi_dma_3/m_axi_s2mm_aclk] [get_bd_pins axi_dma_3/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_2/ACLK] [get_bd_pins axi_mem_intercon_2/M00_ACLK] [get_bd_pins axi_mem_intercon_2/S00_ACLK] [get_bd_pins axi_mem_intercon_3/ACLK] [get_bd_pins axi_mem_intercon_3/M00_ACLK] [get_bd_pins axi_mem_intercon_3/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP3_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI4StreamConstant32_0/m00_axis_aresetn] [get_bd_pins AXI4StreamConstant32_1/m00_axis_aresetn] [get_bd_pins AXI4StreamConstant32_2/m00_axis_aresetn] [get_bd_pins AXI4StreamConstant32_3/m00_axis_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn] [get_bd_pins axi_dma_3/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_2/ARESETN] [get_bd_pins axi_mem_intercon_2/M00_ARESETN] [get_bd_pins axi_mem_intercon_2/S00_ARESETN] [get_bd_pins axi_mem_intercon_3/ARESETN] [get_bd_pins axi_mem_intercon_3/M00_ARESETN] [get_bd_pins axi_mem_intercon_3/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
