...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXI4StreamConstant_0, and set properties
  set AXI4StreamConstant_0 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant:1.0 AXI4StreamConstant_0 ]

  # Create instance: AXI4StreamConstant_1, and set properties
  set AXI4StreamConstant_1 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant:1.0 AXI4StreamConstant_1 ]

  # Create instance: AXI4StreamConstant_2, and set properties
  set AXI4StreamConstant_2 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant:1.0 AXI4StreamConstant_2 ]

  # Create instance: AXI4StreamConstant_3, and set properties
  set AXI4StreamConstant_3 [ create_bd_cell -type ip -vlnv joaomiguelvieira.com:user:AXI4StreamConstant:1.0 AXI4StreamConstant_3 ]
  ...
  connect_bd_intf_net -intf_net AXI4StreamConstant_0_M00_AXIS [get_bd_intf_pins AXI4StreamConstant_0/M00_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI4StreamConstant_1_M00_AXIS [get_bd_intf_pins AXI4StreamConstant_1/M00_AXIS] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI4StreamConstant_2_M00_AXIS [get_bd_intf_pins AXI4StreamConstant_2/M00_AXIS] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net AXI4StreamConstant_3_M00_AXIS [get_bd_intf_pins AXI4StreamConstant_3/M00_AXIS] [get_bd_intf_pins axi_dma_3/S_AXIS_S2MM]
